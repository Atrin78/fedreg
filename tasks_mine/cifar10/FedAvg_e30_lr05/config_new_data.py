...
config = {
    ...
    "use_fed": 1,
    "log_path": "tasks_mine/cifar10/FedAvg_e30_lr05/train_pretrain_new_data.log",
    "save_path": "/scratch/ssd004/scratch/sayromlou/fedreg_models/cifar10/FedAvg_e30_lr05_pretrain_new_data.pt",
    "load_path": None,

...
config = {
    ...
    "use_fed": 1,
    "log_path": "tasks_mine/cifar10/FedReg_e30_lr10/train_pretrain_new_data_final_local.log",
    "save_path": None,
    "load_path": "/scratch/ssd004/scratch/sayromlou/fedreg_models/cifar10/FedReg_e30_lr10_pretrain_new_data_final_10.pt",
    "local_train": True,

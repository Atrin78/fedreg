...
def generate_admm(gen_loader, src_model, device, class_num, synthesize_label, iters_admm, iters_img, param_gamma, param_admm_rho, add_bn_normalization=True, mode='train', batch_size):

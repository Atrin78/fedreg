...
class Client(object):
    def __init__(self, id, group, train_data, eval_data, model, batchsize, train_transform=None, test_transform=None, traincusdataset=None, evalcusdataset=None):
        ...
        if traincusdataset:  # load data use costomer's dataset
            ...
            self.train_data_fortest = DataLoader(evalcusdataset(train_data, transform=test_transform), batch_size=1, shuffle=False,)
            num_workers = 0
            ...
            self.train_data_fortest = DataLoader(CusDataset(train_data, transform=test_transform), batch_size=1, shuffle=False)

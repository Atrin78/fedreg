...
import torch
import sys
from .densenet_ import densenet121


class DenseNetModel(nn.Module):
    def __init__(self, num_classes, optimizer=None, learning_rate=None, seed=1, p_iters=10, ps_eta=0.1, pt_eta=0.001, withclassifier=True):
        super(DenseNetModel, self).__init__()
        self.num_classes = num_classes
        self.num_inp = 64*64*3
        torch.manual_seed(123+seed)

        self.net = densenet121(num_classes=self.num_classes, withclassifier=withclassifier)

...
def get_dataloader_tinyimagenet(root, train=True,  shuffle= True,batch_size=50, dataidxs=None):
    ...
    if train:
        ...
        dataloader = data.DataLoader(
            dataset=dataset, batch_size=batch_size, shuffle=shuffle, num_workers=5
        )
    else:
        dataset = TinyImageNet_Truncated(
